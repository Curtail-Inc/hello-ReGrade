...
const CONFIG: Record<string, HL[]> = {
  ...
  payoff: [{x: 82, y: 463, w: 782, h: 66, from: 0.30, to: 0.92}], // $.total 46.20 → 42.00
};
      ...
      {hls.map((h, i) => {
        ...
        return (
          <div key={i} style={{
            ...
            border: `3px solid ${RED}`, borderRadius: 10, opacity,
            boxShadow: `0 0 24px ${RED}66, inset 0 0 0 9999px ${RED}14`,
          }} />
        );
      })}
    </>
